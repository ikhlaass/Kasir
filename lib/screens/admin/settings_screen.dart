  ...
  Future<void> _loadData() async {
    ...
    if (mounted) {
      setState(() {
        ...
        _qrisImagePath = settings[SettingKeys.qrisPath];
        if (_qrisImagePath?.isEmpty ?? true) _qrisImagePath = null;
        _isLoading = false;
      });
    }
  }
                ...
                children: [
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          _formField(
                            key: const Key('s_desc'),
                            controller: _deskripsiCtrl,
                            label: 'Tagline / Deskripsi',
                          ),
                          const SizedBox(height: 16),
                          _formField(
                            key: const Key('s_addr'),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Upload kode QRIS agar tampil saat kasir memilih pembayaran QRIS.',
                          style: AppFonts.poppins(
                            fontSize: 12,
                            color: AppColors.textMedium,
                          ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Kirim data transaksi lokal ke Supabase dan ambil pembaruan data menu dari perangkat lain.',
                          style: AppFonts.poppins(
                            fontSize: 12,
                            color: AppColors.textMedium,
                          ),
